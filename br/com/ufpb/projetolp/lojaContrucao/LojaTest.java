...
public class LojaTest
{
    ...
    @Test
     public void PosicaoProdutos() {//teste para verificar a posição de cada produto e capacidade de cleintes cadastrados.
        Loja loja1 = new Loja(5,0,0,0);
        Produto produto1 = new Produto();
        ...
        loja1.cadastrarProduto(produto4);
        loja1.cadastrarProduto(produto5);
        assertEquals(produto1, loja1.getProduto(0));
        assertEquals(produto2, loja1.getProduto(1));
        assertEquals(produto3, loja1.getProduto(2));
        assertEquals(produto4, loja1.getProduto(3));
        assertEquals(produto5, loja1.getProduto(4));
    ...
    @Test
     public void PosicaoFuncionarios() {//testando posição do cliente e também o cpf do funcionario.
        ...
        funcionario4.setCpf("4");
        loja1.cadastrarFuncionario(funcionario4);
        Funcionario funcionario5 = new Funcionario();
        funcionario5.setCpf("5");
        loja1.cadastrarFuncionario(funcionario5);
        ...
        assertEquals(funcionario4, loja1.getFuncionario(3));
        assertEquals(funcionario5, loja1.getFuncionario(4));
    ...
    {//Este teste está utilizando o teste com o número do Cpf do funcionario, caso encontre algum funcionário om 
